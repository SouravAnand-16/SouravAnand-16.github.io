...
console.log('%c Designed and Developed by Sourav Anand', 'background-image: linear-gradient(90deg,#8000ff,#6bc5f8); color: white;font-weight:900;font-size:1rem; padding:20px;');
...
document.getElementById('resume-button-2').onclick = () => {
  ...
  window.open(
    "https://drive.google.com/file/d/1biENpylpE3AAE2IOjDynQOBmW4Z0iXHv/view?usp=sharing"
  ),
    setTimeout(() => {
